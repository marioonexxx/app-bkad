...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      <img src="{{ asset('bootslander/assets/img/details-3.png') }}" alt="" class="hero-bg">

      <div class="container">
        <div class="row gy-4 justify-content-between">
          <div class="col-lg-4 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
            <img src="{{ asset('bootslander/assets/img/invoice.svg.svg') }}" class="img-fluid animated" alt="">
          </div>
    ...
    <section id="details" class="details section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Panduan</h2>
        <div><span>PENGUSULAN SPP dan </span> <span class="description-title">SPM</span></div>
      </div>
      <!-- End Section Title -->
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Hubungi Kami</h2>
        <div><span>Jika ada pertanyaan terkait SPP dan SPPM</span> <span class="description-title">Silahkan Hubungi Kami Melalui :</span></div>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                <h3>Alamat</h3>
                <p>Badan Pengelola Keuangan dan Aset Daerah (BPKAD) Kabupaten Maluku Barat Daya</p>
              </div>
            </div><!-- End Info Item -->
            ...
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
              ...
              <div>
                <h3>Email Us</h3>
                <p>bpkad@malukubaratdayakab.go.id</p>
              </div>
            </div><!-- End Info Item -->
